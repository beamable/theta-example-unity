...
namespace ThetaExamples.Scripts
{
    /// <summary>
    ...
    public class AuthPage : TabPage
    {
        ...
        private async void Start()
        {
            ...
            _sdk = new ThirdwebSDK("theta", 137);
        ...
        {
            var address = $"https://mumbai.thetascan.com/address/{Data.WalletId}";
            ...
            async Promise SendAttachRequest(ChallengeSolution challengeSolution = null)
            {
                ...
                if (Data.WalletConnected)
                {
                    RegistrationResult result =
                        await Ctx.Accounts.AddExternalIdentity<ThetaCloudIdentity, ThetaFederationClient>(
                            Data.WalletId,
                            SolveChallenge);
        ...
        private async void OnDetachClicked()
        {
            ...
            await Ctx.Accounts.RemoveExternalIdentity<ThetaCloudIdentity, ThetaFederationClient>();
